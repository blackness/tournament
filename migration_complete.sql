...
-- =============================================================
-- SECTION 9–24: Tables, triggers, views, seed data
-- (players renamed to tournament_players; all trigger bugs fixed)
-- =============================================================
...
-- Note: role-based roster read policy is created after tournament_roles
-- exists in Section 10b below.
...
-- Section 10b: deferred tournament_players policy (requires tournament_roles)
